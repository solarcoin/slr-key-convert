...
console.log(`Your SLR private key: ${keystring}`)
console.log(`Your private key to be imported into your Ethereum wallet: ${wallet.getPrivateKey().toString('hex')}`)
console.log(`Your new Ethereum address: 0x${pubkeyToEthAddress(compressedPublicKey)}`)
console.log(`Your old SLR address: ${pubkeyToSlrAddress(compressedPublicKey)}`)